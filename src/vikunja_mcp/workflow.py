...
_LOST_ARGUMENT_HINT = (
    ...
    "installed the server said so in one line on stderr AT STARTUP and the old silent drop is "
    "back — that line, not this one, is where a typo becomes possible again. What is left: "
