...
- **Тик оркестратора:**
  ...
  3. Агент вернулся с итогом → СНАЧАЛА проверь sha из его `evidence` теми же двумя командами
     ...
     так и не уехал. Не сошлось — ревью не диспатчь (смотреть нечего) и зови `call_human` на
     этой карточке. Сошлось → диспатчишь ревьюера в фоне и даёшь ему СВОЁ дерево:
